...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'draco_stem') documentation build configuration file, created by
...
htmlhelp_basename = 'draco_stemdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'draco_stem.tex',
     u'draco_stem Documentation',
